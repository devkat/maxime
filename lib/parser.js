...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
    ...
    "import": [
      [ "IMPORT qualifiedModuleNames NEWLINE", "$$ = new yy.Import($2);" + loc(1, 3) ]
    ],
...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
    ...
    "featureDecl": [
      [ "FEATURE ucIdentifier typeParams NEWLINE INDENT abstractMethodList OUTDENT",
    ...
    "abstractMethodDecl": [
      [ "lcIdentifier ( params ) returnTypeDecl NEWLINE",
        "$$ = new yy.FunctionDecl($1, $3, $5, null);" + loc(1, 6) ]
    ],
...
/* ----------------------------------------------------------------------
    ...
    */
    ...
    "ctorDecl": [
      ...
      [ "ucIdentifier ( paramList ) NEWLINE methodList", "$$ = new yy.CtorDecl($1, $3, $6);" + loc(1, 6) ]
    ],
    ...
    "methodDecl": [
      [ "lcIdentifier ( params ) returnTypeDecl = blockExpr",
        "$$ = new yy.FunctionDecl($1, $3, $5, $7);" + loc(1, 7) ]
    ],
