...
/* ----------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------- */
    ...
    "defDecl": [
      [ "DEF lcIdentifier funcParams = blockExpr", "$$ = new yy.DefDecl($2, $3, [ $5 ]);" + loc(1, 5)  ],
      [ "DEF lcIdentifier funcParams = NEWLINE INDENT statements OUTDENT", "$$ = new yy.DefDecl($2, $3, $7);" + loc(1, 8) ]
    ],
