...
CaseClause.prototype.populate = function(scope) {
  var clauseScope = scope.createChildScope();
  return new ReflectCaseClause(
    clauseScope,
    this.pattern.populate(clauseScope),
...
ReflectCaseClause.prototype.analyze = function() {
